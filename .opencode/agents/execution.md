---
description: ExecutionProvider (Paper/Shadow/...) e Position Manager. Nunca recebe private key, nunca habilita LIVE.
mode: subagent
tools:
  write: true
  edit: true
...
> Fonte canonica: .agents/execution.md (conteudo integral abaixo; em caso de divergencia, o arquivo em .agents/ prevalece).
