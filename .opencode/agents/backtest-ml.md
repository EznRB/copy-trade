---
description: Backtester com custos reais, walk-forward, anti-leakage, ML tabular e experiment tracking.
mode: subagent
tools:
  write: true
  edit: true
...
> Fonte canonica: .agents/backtest-ml.md (conteudo integral abaixo; em caso de divergencia, o arquivo em .agents/ prevalece).
