...
export function getSharingConfigDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(SHARING_CONFIG_DISCRIMINATOR);
}
...
export function getSharingConfigCodec(): Codec<SharingConfigArgs, SharingConfig> {
...
export function decodeSharingConfig<TAddress extends string = string>(
  ...
  return decodeAccount(encodedAccount as MaybeEncodedAccount<TAddress>, getSharingConfigDecoder());
}
