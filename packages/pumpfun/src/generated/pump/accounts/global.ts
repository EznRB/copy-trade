...
export function getGlobalEncoder(): FixedSizeEncoder<GlobalArgs> {
  return transformEncoder(
    getStructEncoder([
      ...
      ['buybackFeeRecipients', getArrayEncoder(getAddressEncoder(), { size: 8 })],
      ['buybackBasisPoints', getU64Encoder()],
      ['initialVirtualQuoteReserves', getU64Encoder()],
      ['whitelistedQuoteMints', getArrayEncoder(getAddressEncoder(), { size: 1 })],
...
export function getGlobalDecoder(): FixedSizeDecoder<Global> {
  return getStructDecoder([
    ...
    ['whitelistedQuoteMints', getArrayDecoder(getAddressDecoder(), { size: 1 })],
