...
export const GLOBAL_VOLUME_ACCUMULATOR_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
...
export function getGlobalVolumeAccumulatorEncoder(): FixedSizeEncoder<GlobalVolumeAccumulatorArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: GLOBAL_VOLUME_ACCUMULATOR_DISCRIMINATOR }),
  );
}
