...
export const UPDATE_FEE_CONFIG_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  104, 184, 103, 242, 88, 151, 107, 20,
]);

export function getUpdateFeeConfigDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(UPDATE_FEE_CONFIG_DISCRIMINATOR);
}
