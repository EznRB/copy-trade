---
description: Wallet Monitor, classificacao, Wallet Score, Copyability Score, clusters e decay � com evidencia estatistica.
mode: subagent
tools:
  write: true
  edit: true
...
> Fonte canonica: .agents/wallet-intelligence.md (conteudo integral abaixo; em caso de divergencia, o arquivo em .agents/ prevalece).
