---
description: Feature Engine, Consensus Score, Signal Score com regras versionadas. Gera sinais; nunca executa.
mode: subagent
tools:
  write: true
  edit: true
...
> Fonte canonica: .agents/signal-strategy.md (conteudo integral abaixo; em caso de divergencia, o arquivo em .agents/ prevalece).
