...
export const ADD_QUOTE_CONTROL_MINT_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  2, 14, 61, 138, 170, 142, 14, 95,
]);

export function getAddQuoteControlMintDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(ADD_QUOTE_CONTROL_MINT_DISCRIMINATOR);
}

export type AddQuoteControlMintInstruction<
...
export type AddQuoteControlMintInstructionData = {
  discriminator: ReadonlyUint8Array;
  quoteMint: Address;
  initialVirtualQuoteReserves: bigint;
};

export type AddQuoteControlMintInstructionDataArgs = {
  quoteMint: Address;
...
export function getAddQuoteControlMintInstructionDataEncoder(): FixedSizeEncoder<AddQuoteControlMintInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: ADD_QUOTE_CONTROL_MINT_DISCRIMINATOR }),
  );
}
...
export function getAddQuoteControlMintInstructionDataCodec(): FixedSizeCodec<
  AddQuoteControlMintInstructionDataArgs,
  AddQuoteControlMintInstructionData
> {
  return combineCodec(
...
export type ParsedAddQuoteControlMintInstruction<
  TProgram extends string = typeof PUMP_PROGRAM_ADDRESS,
...
> = {
  ...
  data: AddQuoteControlMintInstructionData;
};

export function parseAddQuoteControlMintInstruction<
...
>(
  ...
  return {
    ...
    data: getAddQuoteControlMintInstructionDataDecoder().decode(instruction.data),
  };
}
