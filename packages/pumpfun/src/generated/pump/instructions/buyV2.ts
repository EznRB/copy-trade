...
export type BuyV2InstructionData = {
  discriminator: ReadonlyUint8Array;
  amount: bigint;
  maxSolCost: bigint;
};

export type BuyV2InstructionDataArgs = { amount: number | bigint; maxSolCost: number | bigint };
...
export function getBuyV2InstructionDataCodec(): FixedSizeCodec<
  BuyV2InstructionDataArgs,
  BuyV2InstructionData
> {
  return combineCodec(getBuyV2InstructionDataEncoder(), getBuyV2InstructionDataDecoder());
}
...
> {
  ...
  return Object.freeze({
    ...
    data: getBuyV2InstructionDataEncoder().encode(args as BuyV2InstructionDataArgs),
    programAddress,
  } as BuyV2Instruction<
    TProgramAddress,
    ResolvedInstructionAccountMeta<TAccountGlobal, InstructionAccountInputAddress<TAccountGlobal>>,
...
export type ParsedBuyV2Instruction<
  TProgram extends string = typeof PUMP_PROGRAM_ADDRESS,
...
> = {
  ...
  data: BuyV2InstructionData;
};

export function parseBuyV2Instruction<
...
>(
  ...
  return {
    ...
    data: getBuyV2InstructionDataDecoder().decode(instruction.data),
  };
}
