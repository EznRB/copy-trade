---
description: Token Monitor, Token Risk Score (hard/soft/info) e Creator Risk. Todo bloqueio explicavel.
mode: subagent
tools:
  write: true
  edit: true
...
> Fonte canonica: .agents/token-intelligence.md (conteudo integral abaixo; em caso de divergencia, o arquivo em .agents/ prevalece).
